        ...
        <div className="rounded-2xl p-6" style={{ background: "linear-gradient(160deg, #0f0f1a, #09090f)", border: "1px solid rgba(255,255,255,0.08)" }}>
          {!selectedGame ? (
            <div className="text-center py-20">
                <p className="text-sm font-semibold text-[#e8e8f0]">Selecciona primero una categoria de torneo.</p>
                <p className="text-xs mt-2 text-[#6b6b88]">Aqui veras todos los torneos jugados con su fecha, campeon, MVP y detalles.</p>
            </div>
          ) : (
            <>
              <div className="mb-6">
